...
# RHEL6 gcc specific patch
Patch200: elfutils-0.176-no-shadow-trampolines.patch
Patch201: elfutils-0.176-memalign.patch
...
# RHEL6 GCC specific patch
%patch200 -p1 -b .no_shadow_trampolines
%patch201 -p1 -b .mem_align
...
uname -r; rpm -q glibc || true

# Note on some ancient RHEL6 kernels the core file tests might fail.
# Ignore that by adding 'true' to the end of the make check.
...
- Add elfutils-0.174-no-shadow.patch.
...
- Add elfutils-0.173-index-shadow.patch.
